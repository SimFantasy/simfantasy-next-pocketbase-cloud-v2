		...
		<>
			...
			<div className='page-main flex flex-col'>
				<div className='flex flex-col md:flex-row justify-between items-center gap-6 p-6 bg-gray-50 dark:bg-gray-900 rounded-md'>
					<div className='w-20 h-20 p-2 bg-gray-300 dark:bg-gray-700 rounded-full group overflow-hidden'>
						<img
							src={avatar}
							alt={name}
							width={60}
							height={60}
							className='w-full h-auto rounded-full group-hover:animate-spin cursor-pointer object-cover object-center'
						/>
					</div>
